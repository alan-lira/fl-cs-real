...
1) Line 71: Changed the max_concurrent_workers default value from 1000 to 10000 (Maximum number of clients).
2) Line 73: Changed the keepalive_time_ms default value from 210000 to 7200000 (gRPC keepalive time).
"""
...
def start_grpc_server(  # pylint: disable=too-many-arguments,R0917
    ...
    server_address: str,
    max_concurrent_workers: int = 10000,
