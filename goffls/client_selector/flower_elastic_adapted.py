...
def select_clients_using_elastic_adapted(comm_round: int,
    ...
    if not individual_metrics_history:
        ...
        x, tasks_assignment, selected_clients_indices, makespan, energy_consumption \
        ...
        # Append the corresponding proxies objects and numbers of tasks scheduled of the selected clients into the
